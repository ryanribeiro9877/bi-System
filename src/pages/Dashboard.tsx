                  ...
                  {analytics.perfilIdeal.cboIdeal ? (
                    <>
                      ...
                      <Badge variant="secondary" className="mt-2 bg-emerald-500/20 text-emerald-500">
                        {analytics.perfilIdeal.cboIdeal.totalAprovacoes} aprovações
                      </Badge>
                    </>
                  ) : (
                  ...
                  {analytics.perfilIdeal.bancoIdeal ? (
                    <>
                      ...
                      <Badge variant="secondary" className="mt-2 bg-blue-500/20 text-blue-500">
                        {analytics.perfilIdeal.bancoIdeal.totalAprovacoes} aprovações
                      </Badge>
                    </>
                  ) : (
                    <p className="text-sm text-muted-foreground">Dados insuficientes</p>
                  ...
                  {analytics.perfilIdeal.melhorDiaSemana ? (
                    <>
                      ...
                      <Badge variant="secondary" className="mt-2 bg-purple-500/20 text-purple-500">
                        {analytics.perfilIdeal.melhorDiaSemana.totalPagamentos} pagamentos
                      </Badge>
                    </>
                  ) : (
                    <p className="text-sm text-muted-foreground">Dados insuficientes</p>
                  ...
                  {analytics.bancoMaisAprovacoes ? (
                    <>
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-sm text-muted-foreground">Valor Ganho</span>
                          <span className="font-medium text-emerald-500">{formatCurrency(analytics.valorGanho)}</span>
                        </div>
                      </div>
                    </>
                  ) : (
                    ...
                    <>
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-medium text-red-500">{formatCurrency(analytics.valorPerdido)}</span>
                        </div>
                      </div>
                    </>
                  ) : (
