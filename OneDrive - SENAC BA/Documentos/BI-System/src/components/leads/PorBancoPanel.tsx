...
const PorBancoPanel = ({ bancoFilter = "todos", importBatchId }: PorBancoPanelProps) => {
          ...
          <CardContent>
            <div className="py-12 text-center">
              ...
              <p className="text-muted-foreground mb-4 max-w-md mx-auto">
                Importe seus leads para visualizar estatísticas por banco.
              </p>
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-card border-border">
        <CardHeader className="pb-2">
          ...
          <p className="text-sm text-muted-foreground">
            Análise comparativa das taxas de aprovação
          </p>
        </CardHeader>
        <CardContent>
          <div className="h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData}>
                ...
                <Bar dataKey="pendentes" fill="#f59e0b" name="Pendentes" stackId="a" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-lg">Detalhamento por Banco</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
